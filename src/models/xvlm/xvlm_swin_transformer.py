...
class XVLM_SwinTransformer(BaseBackbone):
    r""" Swin Transformer
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        super(XVLM_SwinTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def forward(self, x, multi=False):
        ...
        final_output = torch.cat([x_cls.transpose(1, 2), x], dim=1)

        return (final_output, multi_scale) if multi else final_output
